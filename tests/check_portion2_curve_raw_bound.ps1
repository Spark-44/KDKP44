...
Assert-Match $guandao '#define\s+PORTION2_CURVE_MAX_RAW_DEVIATION_M\s+0\.12f' `
    'portion2 smooth curve must be bounded within 0.12m of the raw recorded segment.'
