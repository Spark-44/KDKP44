...
Assert-Contains $rearHeader '#define\s+REAR_KI\s+0\.6f' 'Rear motor Ki must match the migrated controller.'
Assert-Contains $rearHeader '#define\s+REAR_KD\s+0\.12f' 'Rear motor Kd must match the migrated controller.'
Assert-Contains $rearHeader '#define\s+REAR_FF_GAIN\s+8\.0f' 'Rear motor feed-forward must match the migrated controller.'
Assert-Contains $rearHeader '#define\s+REAR_PWM_RATE_LIMIT\s+600' 'Rear motor PWM rate limit must match the migrated controller.'
