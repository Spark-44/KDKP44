...
$checks = @(
    ...
    @{ Name = "portion2 pursuit uses softer steering"; Pass = $guandaoC -match "PORTION2_STEERING_CMD_LIMIT\s+15\.0f" -and $guandaoC -match "PORTION2_STEERING_GAIN\s+1\.05f" -and $guandaoC -match "PORTION2_STEER_RATE_LIMIT\s+0\.7f" },
    @{ Name = "portion2 pursuit looks farther ahead"; Pass = $guandaoC -match "PORTION2_MIN_PREVIEW_STEPS\s+10" -and $guandaoC -match "PORTION2_CURVE_PREVIEW_STEPS\s+18" },
