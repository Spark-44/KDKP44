...
$checks = @(
    ...
    @{ Name = "record gps rejection serial log exposes live gnss state"; Pass = $guandaoC -match "\[P2-REC-GPS-SKIP\]" -and $guandaoC -match "reason=%s fix=%u sats=%u coord=%u seq=%lu gps=%u/%u" },
